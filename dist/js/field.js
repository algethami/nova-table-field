...
Component.options.__file = "resources/js/components/FormFields/TableRow.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5d2f8b63", Component.options)
  } else {
    hotAPI.reload("data-v-5d2f8b63", Component.options)
  }
...
Component.options.__file = "resources/js/components/FormFields/Table.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c628dfb2", Component.options)
  } else {
    hotAPI.reload("data-v-c628dfb2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Nova.booting(function (Vue) {
  // Nova Table Field...
  Vue.component('detail-nova-table-field', __webpack_require__(6));
  Vue.component('form-nova-table-field', __webpack_require__(13));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormFields_TableRow__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormFields_TableRow___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__FormFields_TableRow__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FormFields_Table__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FormFields_Table___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__FormFields_Table__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: { Table: __WEBPACK_IMPORTED_MODULE_1__FormFields_Table___default.a, TableRow: __WEBPACK_IMPORTED_MODULE_0__FormFields_TableRow___default.a },
            ...
            _c("textarea", {
              ...
              on: {
                ...
                input: function($event) {
                  ...
                  _vm.$set(_vm.row, index, $event.target.value)
                }
              }
            })
          ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5d2f8b63", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: { "mr-12": _vm.editMode && _vm.canDelete }
    },
    [_vm._t("default")],
    2
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c628dfb2", module.exports)
  }
}
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.number_of_pages > 1 &&
                      _vm.current_page < _vm.number_of_pages
                        ? _c(
                            "div",
                            {
...
Component.options.__file = "resources/js/components/FormFields/TableField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d7caa43", Component.options)
  } else {
    hotAPI.reload("data-v-1d7caa43", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TableRow___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TableRow__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_autosize__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Table__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Table___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Table__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: { Table: __WEBPACK_IMPORTED_MODULE_3__Table___default.a, TableRow: __WEBPACK_IMPORTED_MODULE_1__TableRow___default.a },
  ...
  methods: {
    ...
    addRow: function addRow() {
      ...
      if (this.theData.length + 1 > this.defaultAttributes.maxRows) return this.$toasted.show(this.__('novaTableField.maxRowsError', { max: this.defaultAttributes.maxRows }), {
        type: 'error'
      });

      return _.tap(guid(), function (id) {
        _this.theData = [].concat(_toConsumableArray(_this.theData), [{ id: id, cells: Array(_this.numberOfColumns).join('.').split('.') }]);
        return id;
      });
    },
    ...
    addColumn: function addColumn() {
      ...
      if (this.numberOfColumns + 1 > this.defaultAttributes.maxColumns) return this.$toasted.show(this.__('novaTableField.maxColumnsError', { max: this.defaultAttributes.maxColumns }), {
        type: 'error'
      });
    ...
    removeRow: function removeRow(id) {
      ...
      if (this.theData.length - 1 < this.defaultAttributes.minRows) return this.$toasted.show(this.__('novaTableField.minRowsError', { min: this.defaultAttributes.minRows }), {
        type: 'error'
      });
    ...
    removeColumn: function removeColumn(index) {
      if (this.numberOfColumns - 1 < this.defaultAttributes.minColumns) return this.$toasted.show(this.__('novaTableField.minColumnsError', { min: this.defaultAttributes.minColumns }), {
        type: 'error'
      });
    ...
    selectColumn: function selectColumn() {
      ...
      return this.$nextTick(function () {
        ...
        Object.values(_this5.$refs).map(function (ref) {
          return __WEBPACK_IMPORTED_MODULE_2_autosize___default()(ref[0].$refs.columnFields);
        })[0].slice(-1)[0].select();
      });
    }
  },
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              attrs: {
                "can-delete": _vm.field.canDelete,
                "edit-mode": !_vm.field.readonly
              }
            },
            [
              _c(
          ...
          _vm.field.canDelete
            ? _c(
                ...
                _vm._l(_vm.numberOfColumns, function(n) {
                  return _c(
                    "div",
            ...
            : _vm._e(),
          _vm._v(" "),
          !_vm.field.readonly && _vm.field.canAdd
                ...
                _c(
                  ...
                  [
                    ...
                    _c("span", { staticClass: "ml-1" }, [
                      _vm._v(_vm._s(_vm.__("novaTableField.addRow")))
                    ])
                  ],
                  1
                ),
                _vm._v(" "),
                _vm.numberOfColumns > 0
                  ? _c(
                      "button",
                      {
                        staticClass:
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("span", { staticClass: "ml-1" }, [
                          _vm._v(_vm._s(_vm.__("novaTableField.addColumn")))
                        ])
                      ],
                      1
                    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1d7caa43", module.exports)
  }
}
